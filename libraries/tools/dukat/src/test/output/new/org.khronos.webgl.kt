...
public val org.khronos.webgl.WebGLPowerPreference.Companion.DEFAULT: org.khronos.webgl.WebGLPowerPreference
    public inline fun org.khronos.webgl.WebGLPowerPreference.Companion.<get-DEFAULT>(): org.khronos.webgl.WebGLPowerPreference
public val org.khronos.webgl.WebGLPowerPreference.Companion.HIGH_PERFORMANCE: org.khronos.webgl.WebGLPowerPreference
    public inline fun org.khronos.webgl.WebGLPowerPreference.Companion.<get-HIGH_PERFORMANCE>(): org.khronos.webgl.WebGLPowerPreference
public val org.khronos.webgl.WebGLPowerPreference.Companion.LOW_POWER: org.khronos.webgl.WebGLPowerPreference
    public inline fun org.khronos.webgl.WebGLPowerPreference.Companion.<get-LOW_POWER>(): org.khronos.webgl.WebGLPowerPreference
@kotlin.internal.InlineOnly public inline fun WebGLContextAttributes(/*0*/ alpha: kotlin.Boolean? = ..., /*1*/ depth: kotlin.Boolean? = ..., /*2*/ stencil: kotlin.Boolean? = ..., /*3*/ antialias: kotlin.Boolean? = ..., /*4*/ premultipliedAlpha: kotlin.Boolean? = ..., /*5*/ preserveDrawingBuffer: kotlin.Boolean? = ..., /*6*/ powerPreference: org.khronos.webgl.WebGLPowerPreference? = ..., /*7*/ failIfMajorPerformanceCaveat: kotlin.Boolean? = ..., /*8*/ desynchronized: kotlin.Boolean? = ...): org.khronos.webgl.WebGLContextAttributes
...
public open external class ArrayBuffer : org.khronos.webgl.BufferSource {
...
public external interface ArrayBufferView : org.khronos.webgl.BufferSource {
...
public external interface WebGLContextAttributes {
    ...
    public open var desynchronized: kotlin.Boolean?
        public open fun <get-desynchronized>(): kotlin.Boolean?
        public open fun <set-desynchronized>(/*0*/ value: kotlin.Boolean?): kotlin.Unit
    ...
    public open var powerPreference: org.khronos.webgl.WebGLPowerPreference?
        public open fun <get-powerPreference>(): org.khronos.webgl.WebGLPowerPreference?
        public open fun <set-powerPreference>(/*0*/ value: org.khronos.webgl.WebGLPowerPreference?): kotlin.Unit
...
@kotlin.Suppress(names = {"NESTED_CLASS_IN_EXTERNAL_INTERFACE"}) public external interface WebGLPowerPreference {
    public open override /*1*/ /*fake_override*/ fun equals(/*0*/ other: kotlin.Any?): kotlin.Boolean
    public open override /*1*/ /*fake_override*/ fun hashCode(): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun toString(): kotlin.String
...
public abstract external class WebGLRenderingContext {
    /*primary*/ public constructor WebGLRenderingContext()
    public open var canvas: org.khronos.webgl.UnionHTMLCanvasElementOrOffscreenCanvas
        public open fun <get-canvas>(): org.khronos.webgl.UnionHTMLCanvasElementOrOffscreenCanvas
        public open fun <set-canvas>(/*0*/ <set-?>: org.khronos.webgl.UnionHTMLCanvasElementOrOffscreenCanvas): kotlin.Unit
    public open var drawingBufferHeight: kotlin.Int
        public open fun <get-drawingBufferHeight>(): kotlin.Int
        public open fun <set-drawingBufferHeight>(/*0*/ <set-?>: kotlin.Int): kotlin.Unit
    public open var drawingBufferWidth: kotlin.Int
        public open fun <get-drawingBufferWidth>(): kotlin.Int
        public open fun <set-drawingBufferWidth>(/*0*/ <set-?>: kotlin.Int): kotlin.Unit
    public final fun activeTexture(/*0*/ texture: kotlin.Int): kotlin.Unit
    public final fun attachShader(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ shader: org.khronos.webgl.WebGLShader): kotlin.Unit
    public final fun bindAttribLocation(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ index: kotlin.Int, /*2*/ name: kotlin.String): kotlin.Unit
    public final fun bindBuffer(/*0*/ target: kotlin.Int, /*1*/ buffer: org.khronos.webgl.WebGLBuffer?): kotlin.Unit
    public final fun bindFramebuffer(/*0*/ target: kotlin.Int, /*1*/ framebuffer: org.khronos.webgl.WebGLFramebuffer?): kotlin.Unit
    public final fun bindRenderbuffer(/*0*/ target: kotlin.Int, /*1*/ renderbuffer: org.khronos.webgl.WebGLRenderbuffer?): kotlin.Unit
    public final fun bindTexture(/*0*/ target: kotlin.Int, /*1*/ texture: org.khronos.webgl.WebGLTexture?): kotlin.Unit
    public final fun blendColor(/*0*/ red: kotlin.Float, /*1*/ green: kotlin.Float, /*2*/ blue: kotlin.Float, /*3*/ alpha: kotlin.Float): kotlin.Unit
    public final fun blendEquation(/*0*/ mode: kotlin.Int): kotlin.Unit
    public final fun blendEquationSeparate(/*0*/ modeRGB: kotlin.Int, /*1*/ modeAlpha: kotlin.Int): kotlin.Unit
    public final fun blendFunc(/*0*/ sfactor: kotlin.Int, /*1*/ dfactor: kotlin.Int): kotlin.Unit
    public final fun blendFuncSeparate(/*0*/ srcRGB: kotlin.Int, /*1*/ dstRGB: kotlin.Int, /*2*/ srcAlpha: kotlin.Int, /*3*/ dstAlpha: kotlin.Int): kotlin.Unit
    public final fun bufferData(/*0*/ target: kotlin.Int, /*1*/ size: kotlin.Int, /*2*/ usage: kotlin.Int): kotlin.Unit
    public final fun bufferData(/*0*/ target: kotlin.Int, /*1*/ data: org.khronos.webgl.BufferSource?, /*2*/ usage: kotlin.Int): kotlin.Unit
    public final fun bufferSubData(/*0*/ target: kotlin.Int, /*1*/ offset: kotlin.Int, /*2*/ data: org.khronos.webgl.BufferSource): kotlin.Unit
    public final fun checkFramebufferStatus(/*0*/ target: kotlin.Int): kotlin.Int
    public final fun clear(/*0*/ mask: kotlin.Int): kotlin.Unit
    public final fun clearColor(/*0*/ red: kotlin.Float, /*1*/ green: kotlin.Float, /*2*/ blue: kotlin.Float, /*3*/ alpha: kotlin.Float): kotlin.Unit
    public final fun clearDepth(/*0*/ depth: kotlin.Float): kotlin.Unit
    public final fun clearStencil(/*0*/ s: kotlin.Int): kotlin.Unit
    public final fun colorMask(/*0*/ red: kotlin.Boolean, /*1*/ green: kotlin.Boolean, /*2*/ blue: kotlin.Boolean, /*3*/ alpha: kotlin.Boolean): kotlin.Unit
    public final fun compileShader(/*0*/ shader: org.khronos.webgl.WebGLShader): kotlin.Unit
    public final fun compressedTexImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ internalformat: kotlin.Int, /*3*/ width: kotlin.Int, /*4*/ height: kotlin.Int, /*5*/ border: kotlin.Int, /*6*/ data: org.khronos.webgl.ArrayBufferView): kotlin.Unit
    public final fun compressedTexSubImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ xoffset: kotlin.Int, /*3*/ yoffset: kotlin.Int, /*4*/ width: kotlin.Int, /*5*/ height: kotlin.Int, /*6*/ format: kotlin.Int, /*7*/ data: org.khronos.webgl.ArrayBufferView): kotlin.Unit
    public final fun copyTexImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ internalformat: kotlin.Int, /*3*/ x: kotlin.Int, /*4*/ y: kotlin.Int, /*5*/ width: kotlin.Int, /*6*/ height: kotlin.Int, /*7*/ border: kotlin.Int): kotlin.Unit
    public final fun copyTexSubImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ xoffset: kotlin.Int, /*3*/ yoffset: kotlin.Int, /*4*/ x: kotlin.Int, /*5*/ y: kotlin.Int, /*6*/ width: kotlin.Int, /*7*/ height: kotlin.Int): kotlin.Unit
    public final fun createBuffer(): org.khronos.webgl.WebGLBuffer?
    public final fun createFramebuffer(): org.khronos.webgl.WebGLFramebuffer?
    public final fun createProgram(): org.khronos.webgl.WebGLProgram?
    public final fun createRenderbuffer(): org.khronos.webgl.WebGLRenderbuffer?
    public final fun createShader(/*0*/ type: kotlin.Int): org.khronos.webgl.WebGLShader?
    public final fun createTexture(): org.khronos.webgl.WebGLTexture?
    public final fun cullFace(/*0*/ mode: kotlin.Int): kotlin.Unit
    public final fun deleteBuffer(/*0*/ buffer: org.khronos.webgl.WebGLBuffer?): kotlin.Unit
    public final fun deleteFramebuffer(/*0*/ framebuffer: org.khronos.webgl.WebGLFramebuffer?): kotlin.Unit
    public final fun deleteProgram(/*0*/ program: org.khronos.webgl.WebGLProgram?): kotlin.Unit
    public final fun deleteRenderbuffer(/*0*/ renderbuffer: org.khronos.webgl.WebGLRenderbuffer?): kotlin.Unit
    public final fun deleteShader(/*0*/ shader: org.khronos.webgl.WebGLShader?): kotlin.Unit
    public final fun deleteTexture(/*0*/ texture: org.khronos.webgl.WebGLTexture?): kotlin.Unit
    public final fun depthFunc(/*0*/ func: kotlin.Int): kotlin.Unit
    public final fun depthMask(/*0*/ flag: kotlin.Boolean): kotlin.Unit
    public final fun depthRange(/*0*/ zNear: kotlin.Float, /*1*/ zFar: kotlin.Float): kotlin.Unit
    public final fun detachShader(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ shader: org.khronos.webgl.WebGLShader): kotlin.Unit
    public final fun disable(/*0*/ cap: kotlin.Int): kotlin.Unit
    public final fun disableVertexAttribArray(/*0*/ index: kotlin.Int): kotlin.Unit
    public final fun drawArrays(/*0*/ mode: kotlin.Int, /*1*/ first: kotlin.Int, /*2*/ count: kotlin.Int): kotlin.Unit
    public final fun drawElements(/*0*/ mode: kotlin.Int, /*1*/ count: kotlin.Int, /*2*/ type: kotlin.Int, /*3*/ offset: kotlin.Int): kotlin.Unit
    public final fun enable(/*0*/ cap: kotlin.Int): kotlin.Unit
    public final fun enableVertexAttribArray(/*0*/ index: kotlin.Int): kotlin.Unit
    public open override /*1*/ /*fake_override*/ fun equals(/*0*/ other: kotlin.Any?): kotlin.Boolean
    public final fun finish(): kotlin.Unit
    public final fun flush(): kotlin.Unit
    public final fun framebufferRenderbuffer(/*0*/ target: kotlin.Int, /*1*/ attachment: kotlin.Int, /*2*/ renderbuffertarget: kotlin.Int, /*3*/ renderbuffer: org.khronos.webgl.WebGLRenderbuffer?): kotlin.Unit
    public final fun framebufferTexture2D(/*0*/ target: kotlin.Int, /*1*/ attachment: kotlin.Int, /*2*/ textarget: kotlin.Int, /*3*/ texture: org.khronos.webgl.WebGLTexture?, /*4*/ level: kotlin.Int): kotlin.Unit
    public final fun frontFace(/*0*/ mode: kotlin.Int): kotlin.Unit
    public final fun generateMipmap(/*0*/ target: kotlin.Int): kotlin.Unit
    public final fun getActiveAttrib(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ index: kotlin.Int): org.khronos.webgl.WebGLActiveInfo?
    public final fun getActiveUniform(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ index: kotlin.Int): org.khronos.webgl.WebGLActiveInfo?
    public final fun getAttachedShaders(/*0*/ program: org.khronos.webgl.WebGLProgram): kotlin.Array<org.khronos.webgl.WebGLShader>?
    public final fun getAttribLocation(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ name: kotlin.String): kotlin.Int
    public final fun getBufferParameter(/*0*/ target: kotlin.Int, /*1*/ pname: kotlin.Int): kotlin.Any?
    public final fun getContextAttributes(): org.khronos.webgl.WebGLContextAttributes?
    public final fun getError(): kotlin.Int
    public final fun getExtension(/*0*/ name: kotlin.String): dynamic
    public final fun getFramebufferAttachmentParameter(/*0*/ target: kotlin.Int, /*1*/ attachment: kotlin.Int, /*2*/ pname: kotlin.Int): kotlin.Any?
    public final fun getParameter(/*0*/ pname: kotlin.Int): kotlin.Any?
    public final fun getProgramInfoLog(/*0*/ program: org.khronos.webgl.WebGLProgram): kotlin.String?
    public final fun getProgramParameter(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ pname: kotlin.Int): kotlin.Any?
    public final fun getRenderbufferParameter(/*0*/ target: kotlin.Int, /*1*/ pname: kotlin.Int): kotlin.Any?
    public final fun getShaderInfoLog(/*0*/ shader: org.khronos.webgl.WebGLShader): kotlin.String?
    public final fun getShaderParameter(/*0*/ shader: org.khronos.webgl.WebGLShader, /*1*/ pname: kotlin.Int): kotlin.Any?
    public final fun getShaderPrecisionFormat(/*0*/ shadertype: kotlin.Int, /*1*/ precisiontype: kotlin.Int): org.khronos.webgl.WebGLShaderPrecisionFormat?
    public final fun getShaderSource(/*0*/ shader: org.khronos.webgl.WebGLShader): kotlin.String?
    public final fun getSupportedExtensions(): kotlin.Array<kotlin.String>?
    public final fun getTexParameter(/*0*/ target: kotlin.Int, /*1*/ pname: kotlin.Int): kotlin.Any?
    public final fun getUniform(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ location: org.khronos.webgl.WebGLUniformLocation): kotlin.Any?
    public final fun getUniformLocation(/*0*/ program: org.khronos.webgl.WebGLProgram, /*1*/ name: kotlin.String): org.khronos.webgl.WebGLUniformLocation?
    public final fun getVertexAttrib(/*0*/ index: kotlin.Int, /*1*/ pname: kotlin.Int): kotlin.Any?
    public final fun getVertexAttribOffset(/*0*/ index: kotlin.Int, /*1*/ pname: kotlin.Int): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun hashCode(): kotlin.Int
    public final fun hint(/*0*/ target: kotlin.Int, /*1*/ mode: kotlin.Int): kotlin.Unit
    public final fun isBuffer(/*0*/ buffer: org.khronos.webgl.WebGLBuffer?): kotlin.Boolean
    public final fun isContextLost(): kotlin.Boolean
    public final fun isEnabled(/*0*/ cap: kotlin.Int): kotlin.Boolean
    public final fun isFramebuffer(/*0*/ framebuffer: org.khronos.webgl.WebGLFramebuffer?): kotlin.Boolean
    public final fun isProgram(/*0*/ program: org.khronos.webgl.WebGLProgram?): kotlin.Boolean
    public final fun isRenderbuffer(/*0*/ renderbuffer: org.khronos.webgl.WebGLRenderbuffer?): kotlin.Boolean
    public final fun isShader(/*0*/ shader: org.khronos.webgl.WebGLShader?): kotlin.Boolean
    public final fun isTexture(/*0*/ texture: org.khronos.webgl.WebGLTexture?): kotlin.Boolean
    public final fun lineWidth(/*0*/ width: kotlin.Float): kotlin.Unit
    public final fun linkProgram(/*0*/ program: org.khronos.webgl.WebGLProgram): kotlin.Unit
    public final fun pixelStorei(/*0*/ pname: kotlin.Int, /*1*/ param: kotlin.Int): kotlin.Unit
    public final fun polygonOffset(/*0*/ factor: kotlin.Float, /*1*/ units: kotlin.Float): kotlin.Unit
    public final fun readPixels(/*0*/ x: kotlin.Int, /*1*/ y: kotlin.Int, /*2*/ width: kotlin.Int, /*3*/ height: kotlin.Int, /*4*/ format: kotlin.Int, /*5*/ type: kotlin.Int, /*6*/ pixels: org.khronos.webgl.ArrayBufferView?): kotlin.Unit
    public final fun renderbufferStorage(/*0*/ target: kotlin.Int, /*1*/ internalformat: kotlin.Int, /*2*/ width: kotlin.Int, /*3*/ height: kotlin.Int): kotlin.Unit
    public final fun sampleCoverage(/*0*/ value: kotlin.Float, /*1*/ invert: kotlin.Boolean): kotlin.Unit
    public final fun scissor(/*0*/ x: kotlin.Int, /*1*/ y: kotlin.Int, /*2*/ width: kotlin.Int, /*3*/ height: kotlin.Int): kotlin.Unit
    public final fun shaderSource(/*0*/ shader: org.khronos.webgl.WebGLShader, /*1*/ source: kotlin.String): kotlin.Unit
    public final fun stencilFunc(/*0*/ func: kotlin.Int, /*1*/ ref: kotlin.Int, /*2*/ mask: kotlin.Int): kotlin.Unit
    public final fun stencilFuncSeparate(/*0*/ face: kotlin.Int, /*1*/ func: kotlin.Int, /*2*/ ref: kotlin.Int, /*3*/ mask: kotlin.Int): kotlin.Unit
    public final fun stencilMask(/*0*/ mask: kotlin.Int): kotlin.Unit
    public final fun stencilMaskSeparate(/*0*/ face: kotlin.Int, /*1*/ mask: kotlin.Int): kotlin.Unit
    public final fun stencilOp(/*0*/ fail: kotlin.Int, /*1*/ zfail: kotlin.Int, /*2*/ zpass: kotlin.Int): kotlin.Unit
    public final fun stencilOpSeparate(/*0*/ face: kotlin.Int, /*1*/ fail: kotlin.Int, /*2*/ zfail: kotlin.Int, /*3*/ zpass: kotlin.Int): kotlin.Unit
    public final fun texImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ internalformat: kotlin.Int, /*3*/ width: kotlin.Int, /*4*/ height: kotlin.Int, /*5*/ border: kotlin.Int, /*6*/ format: kotlin.Int, /*7*/ type: kotlin.Int, /*8*/ pixels: org.khronos.webgl.ArrayBufferView?): kotlin.Unit
    public final fun texImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ internalformat: kotlin.Int, /*3*/ format: kotlin.Int, /*4*/ type: kotlin.Int, /*5*/ source: org.khronos.webgl.TexImageSource): kotlin.Unit
    public final fun texParameterf(/*0*/ target: kotlin.Int, /*1*/ pname: kotlin.Int, /*2*/ param: kotlin.Float): kotlin.Unit
    public final fun texParameteri(/*0*/ target: kotlin.Int, /*1*/ pname: kotlin.Int, /*2*/ param: kotlin.Int): kotlin.Unit
    public final fun texSubImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ xoffset: kotlin.Int, /*3*/ yoffset: kotlin.Int, /*4*/ width: kotlin.Int, /*5*/ height: kotlin.Int, /*6*/ format: kotlin.Int, /*7*/ type: kotlin.Int, /*8*/ pixels: org.khronos.webgl.ArrayBufferView?): kotlin.Unit
    public final fun texSubImage2D(/*0*/ target: kotlin.Int, /*1*/ level: kotlin.Int, /*2*/ xoffset: kotlin.Int, /*3*/ yoffset: kotlin.Int, /*4*/ format: kotlin.Int, /*5*/ type: kotlin.Int, /*6*/ source: org.khronos.webgl.TexImageSource): kotlin.Unit
    public open override /*1*/ /*fake_override*/ fun toString(): kotlin.String
    public final fun uniform1f(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Float): kotlin.Unit
    public final fun uniform1fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform1i(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Int): kotlin.Unit
    public final fun uniform1iv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform2f(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Float, /*2*/ y: kotlin.Float): kotlin.Unit
    public final fun uniform2fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform2i(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Int, /*2*/ y: kotlin.Int): kotlin.Unit
    public final fun uniform2iv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform3f(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Float, /*2*/ y: kotlin.Float, /*3*/ z: kotlin.Float): kotlin.Unit
    public final fun uniform3fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform3i(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Int, /*2*/ y: kotlin.Int, /*3*/ z: kotlin.Int): kotlin.Unit
    public final fun uniform3iv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform4f(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Float, /*2*/ y: kotlin.Float, /*3*/ z: kotlin.Float, /*4*/ w: kotlin.Float): kotlin.Unit
    public final fun uniform4fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniform4i(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ x: kotlin.Int, /*2*/ y: kotlin.Int, /*3*/ z: kotlin.Int, /*4*/ w: kotlin.Int): kotlin.Unit
    public final fun uniform4iv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ v: dynamic): kotlin.Unit
    public final fun uniformMatrix2fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ transpose: kotlin.Boolean, /*2*/ value: dynamic): kotlin.Unit
    public final fun uniformMatrix3fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ transpose: kotlin.Boolean, /*2*/ value: dynamic): kotlin.Unit
    public final fun uniformMatrix4fv(/*0*/ location: org.khronos.webgl.WebGLUniformLocation?, /*1*/ transpose: kotlin.Boolean, /*2*/ value: dynamic): kotlin.Unit
    public final fun useProgram(/*0*/ program: org.khronos.webgl.WebGLProgram?): kotlin.Unit
    public final fun validateProgram(/*0*/ program: org.khronos.webgl.WebGLProgram): kotlin.Unit
    public final fun vertexAttrib1f(/*0*/ index: kotlin.Int, /*1*/ x: kotlin.Float): kotlin.Unit
    public final fun vertexAttrib1fv(/*0*/ index: kotlin.Int, /*1*/ values: dynamic): kotlin.Unit
    public final fun vertexAttrib2f(/*0*/ index: kotlin.Int, /*1*/ x: kotlin.Float, /*2*/ y: kotlin.Float): kotlin.Unit
    public final fun vertexAttrib2fv(/*0*/ index: kotlin.Int, /*1*/ values: dynamic): kotlin.Unit
    public final fun vertexAttrib3f(/*0*/ index: kotlin.Int, /*1*/ x: kotlin.Float, /*2*/ y: kotlin.Float, /*3*/ z: kotlin.Float): kotlin.Unit
    public final fun vertexAttrib3fv(/*0*/ index: kotlin.Int, /*1*/ values: dynamic): kotlin.Unit
    public final fun vertexAttrib4f(/*0*/ index: kotlin.Int, /*1*/ x: kotlin.Float, /*2*/ y: kotlin.Float, /*3*/ z: kotlin.Float, /*4*/ w: kotlin.Float): kotlin.Unit
    public final fun vertexAttrib4fv(/*0*/ index: kotlin.Int, /*1*/ values: dynamic): kotlin.Unit
    public final fun vertexAttribPointer(/*0*/ index: kotlin.Int, /*1*/ size: kotlin.Int, /*2*/ type: kotlin.Int, /*3*/ normalized: kotlin.Boolean, /*4*/ stride: kotlin.Int, /*5*/ offset: kotlin.Int): kotlin.Unit
    public final fun viewport(/*0*/ x: kotlin.Int, /*1*/ y: kotlin.Int, /*2*/ width: kotlin.Int, /*3*/ height: kotlin.Int): kotlin.Unit
...
public abstract external class WebGLShader : org.khronos.webgl.WebGLObject {
    /*primary*/ public constructor WebGLShader()
    public open override /*1*/ /*fake_override*/ fun equals(/*0*/ other: kotlin.Any?): kotlin.Boolean
    public open override /*1*/ /*fake_override*/ fun hashCode(): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun toString(): kotlin.String
}
...
public abstract external class WebGLShaderPrecisionFormat {
    /*primary*/ public constructor WebGLShaderPrecisionFormat()
    public open val precision: kotlin.Int
        public open fun <get-precision>(): kotlin.Int
    public open val rangeMax: kotlin.Int
        public open fun <get-rangeMax>(): kotlin.Int
    public open val rangeMin: kotlin.Int
        public open fun <get-rangeMin>(): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun equals(/*0*/ other: kotlin.Any?): kotlin.Boolean
    public open override /*1*/ /*fake_override*/ fun hashCode(): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun toString(): kotlin.String
}
...
public abstract external class WebGLTexture : org.khronos.webgl.WebGLObject {
    /*primary*/ public constructor WebGLTexture()
    public open override /*1*/ /*fake_override*/ fun equals(/*0*/ other: kotlin.Any?): kotlin.Boolean
    public open override /*1*/ /*fake_override*/ fun hashCode(): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun toString(): kotlin.String
}
...
public abstract external class WebGLUniformLocation {
    /*primary*/ public constructor WebGLUniformLocation()
    public open override /*1*/ /*fake_override*/ fun equals(/*0*/ other: kotlin.Any?): kotlin.Boolean
    public open override /*1*/ /*fake_override*/ fun hashCode(): kotlin.Int
    public open override /*1*/ /*fake_override*/ fun toString(): kotlin.String
}
