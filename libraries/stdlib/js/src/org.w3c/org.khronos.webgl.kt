...
inline fun WebGLContextAttributes(alpha: Boolean? = true, depth: Boolean? = true, stencil: Boolean? = false, antialias: Boolean? = true, premultipliedAlpha: Boolean? = true, preserveDrawingBuffer: Boolean? = false, powerPreference: WebGLPowerPreference? = WebGLPowerPreference.DEFAULT, failIfMajorPerformanceCaveat: Boolean? = false, desynchronized: Boolean? = false): WebGLContextAttributes {
    val o = js("({})")
    o["alpha"] = alpha
    o["depth"] = depth
    o["stencil"] = stencil
 ...
 */
external abstract class WebGLRenderingContext {
    open var canvas: UnionHTMLCanvasElementOrOffscreenCanvas
    open var drawingBufferWidth: Int
    open var drawingBufferHeight: Int
    ...
    fun bufferData(target: Int, data: BufferSource?, usage: Int)
    fun bufferSubData(target: Int, offset: Int, data: BufferSource)
 ...
 */
external open class ArrayBuffer(length: Int) : BufferSource {
...
inline val WebGLPowerPreference.Companion.DEFAULT: WebGLPowerPreference get() = "default".asDynamic().unsafeCast<WebGLPowerPreference>()

inline val WebGLPowerPreference.Companion.LOW_POWER: WebGLPowerPreference get() = "low-power".asDynamic().unsafeCast<WebGLPowerPreference>()

inline val WebGLPowerPreference.Companion.HIGH_PERFORMANCE: WebGLPowerPreference get() = "high-performance".asDynamic().unsafeCast<WebGLPowerPreference>()